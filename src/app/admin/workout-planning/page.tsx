...
export default function WorkoutPlanningPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-neutral-200">
      {/* Header */}
      <header className="h-14 border-b border-white/5 flex items-center justify-between px-6 bg-[#0d0d0d]">
        <div className="flex items-center gap-4">
          <Link href="/admin" className="p-2 hover:bg-white/5 rounded-xl transition-all">
            <ArrowLeft size={20} />
          </Link>
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center shadow-[0_0_15px_rgba(251,146,60,0.3)]">
              <Calendar size={18} className="text-black" />
            </div>
            <span className="font-black text-[13px] uppercase tracking-[0.2em]">
              Планирование <span className="text-neutral-500 font-bold">тренировок</span>
            </span>
          </div>
        </div>
