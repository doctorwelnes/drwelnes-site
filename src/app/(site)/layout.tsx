        ...
        <div className="mx-auto flex max-w-[980px] items-center justify-between gap-4 px-5 py-3">
          <div className="flex items-center gap-2.5">
            <Image
              ...
              width={34}
              height={34}
              className="h-[34px] w-[34px] rounded-linear object-cover shadow-sm"
          ...
          <button
            type="button"
            className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-zinc-200 bg-white/90 text-xl shadow-sm sm:hidden"
          >
            ☰
          </button>
        </div>
